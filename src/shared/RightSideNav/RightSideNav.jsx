  ...
  return (
    <div>
      <div className="p-4 space-y-3 mb-6">
        <h2 className="text-2xl mb-1 font-semibold">Login with</h2>
      ...
      <div className="p-4 mb-6">
        <h2 className="text-2xl mb-1 font-semibold">Find Us On</h2>
        <a
        ...
        <a
          className="p-4 flex text-lg items-center border rounded-x-lg"
          href=""
        >
